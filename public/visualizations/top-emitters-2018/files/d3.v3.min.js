!(function () {
  ...
  function gu(n, t) {
    ...
    let e = n.r,
      ...
      a = t.b - u;
    return function (n) {
      return `#${xt(Math.round(e + i * n))}${xt(Math.round(r + o * n))}${xt(
        Math.round(u + a * n)
      )}`;
    };
  }
  ...
  function _i(n, t, e, r) {
    ...
    if (((n.x = t += r * n.x), (n.y = e += r * n.y), (n.r *= r), u)) {
      for (let i = -1, o = u.length; ++i < o;) _i(u[i], t, e, r);
    }
  }
  function wi(n, t, e) {
    let r = n.r + e.r,
  ...
  function ho(n) {
    ...
    return (
      ...
      (t.interpolate = function (n) {
        return arguments.length
          ? ((o =
              typeof n === 'function' ? (i = n) : (i = El.get(n) || go).key),
            t)
          : o;
      }),
  ...
  function _o(n, t) {
    ...
    if (
      (e &&
        ((r += `Q${i[0] - (2 * o[0]) / 3},${i[1] - (2 * o[1]) / 3},${i[0]},${
          i[1]
        }`),
          (u = n[1]),
          (c = 2)),
      ...
      (i = n[c]),
      c++,
      (r += `C${u[0] + o[0]},${u[1] + o[1]},${i[0] - a[0]},${i[1] - a[1]},${
        i[0]
      },${i[1]}`);
  ...
  function Do(n) {
    ...
    return (
      ...
      (t.interpolate = function (n) {
        return arguments.length
          ? ((c =
              typeof n === 'function' ? (a = n) : (a = El.get(n) || go).key),
            (l = a.reverse || a),
            (s = a.closed ? 'M' : 'L'),
            t)
          : c;
  ...
  (ta.behavior.zoom = function () {
    ...
    function h() {
      ...
      function t() {
        ...
        _.push(t);
        for (
          let e = ta.event.changedTouches, u = 0, i = e.length;
          i > u;
          ++u
        ) {
  ...
  var vc = {
      ...
      FeatureCollection(n, t) {
        for (let e = n.features, r = -1, u = e.length; ++r < u;) {
          se(e[r].geometry, t);
        }
      }
    },
    dc = {
      ...
      MultiPoint(n, t) {
        for (let e = n.coordinates, r = -1, u = e.length; ++r < u;) {
  ...
  var zl = ta.map({
    ...
    cross(n) {
      ...
      return `M${-3 * t},${-t}H${-t}V${-3 * t}H${t}V${-t}H${3 *
        t}V${t}H${t}V${3 * t}H${-t}V${t}H${-3 * t}Z`;
    },
    diamond(n) {

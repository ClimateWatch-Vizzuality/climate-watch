!(function (t) {
  ...
  window.atwpjp = function (o, s) {
    for (var r, l, c = 0, h = []; c < o.length; c++) { (l = o[c]), n[l] && h.push(...n[l]), (n[l] = 0); }
    for (r in s) {
      const d = s[r];
      switch (typeof d) {
        case 'number':
  ...
  (function (t) {
    ...
    function (t) {
      ...
      var c = {},
        h = function (t) {
          let e;
          return function () {
            return typeof e === 'undefined' && (e = t.apply(this, arguments)), e;
          };
        },
        d = h(function () {
      ...
      t.exports = function (t, i) {
        (i = i || {}), typeof i.singleton === 'undefined' && (i.singleton = d());
        const n = a(t);
        return (
          e(n, i),
          function (t) {
    ...
    function (t) {
      t.exports = function (t, e, a) {
        let i,
          n = [];
        if (((a = void 0 !== a ? a : this), t === null || void 0 === t)) { return n; }
    ...
    function (t) {
      t.exports = function (t, e, a, i) {
        ...
        if (t instanceof Array) {
          for (let n = 0, o = t.length, s = t[0]; o > n; s = t[++n]) { a = e.call(i || t, a, s, n, t); }
        } else {
          for (const r in t) {
            t instanceof Object
    ...
    function (t, e, a) {
        ...
        if ((Ta.gov(), !ra('addthis_widget.js').library)) {
          ...
          if (
            ...
            if (c.data_track_addressbar_paths) {
              se = 0;
              for (let re = 0; re < c.data_track_addressbar_paths.length; re++) {
                if (
                  ((ne = new RegExp(
        ...
        for (let r = 0; o > r; r++) {
          if ((a = t.attributes[r])) {
            if (((i = a.name.split(`${e}:`)), !i || i.length == 1)) {
              ...
              if (((i = a.name.split(`data-${s}-`)), !i || i.length == 1)) { continue; }
            }
                  ...
                  : ((_ate.maf = _ate.maf || {}),
                    ...
                    (E.onfocus = E.onmouseover = function () {
                      ...
                      if (!_ate.maf.sib || _ate.maf.sib.nodeType == 3) {
                        ...
                        if (t) {
                          for (; t.nextSibling && t.nodeType == 3;) { t = t.nextSibling; }
                        } else {
                          for (
          ...
          if (c != null && (n !== !1 || !c.ost)) {
            ...
            if (
              ...
              let P = d.ce('a'),
                Y = d.ce('a');
              (P.className =
                `addthis_native_counter_sibling addthis_button_${z}`),
              (Y.className =
      ...
      if (
            ...
            if (T.length > 0) {
              ...
              let n =
                    `${N
                      ...
                      ? `&dr=${_euc(e.track.mgu(e.dr, { defrag: 1 }))}`
                      : ''
                    }${e.du
                      ? `&PRE=${_euc(e.track.mgu(e.du, { defrag: 1 }))}`
                      : ''}`,
                o = R + n;
        ...
        (function (t) {
          ...
          function i(t, e) {
            ...
            return (
              ...
              i
                ? `&passthrough=${
                  w.trim(typeof i === 'object' ? w.util.toKV(i) : i, 1)}`
                : ''
            );
          }
          function n(t, e, n, o) {
            ...
            return (
              ...
              (l =
                  ...
                  !(
                    ...
                    _euc(w.uid && w.uid != 'x' ? w.uid : w.util.cuid())
                  }${n.email_template
          ...
          function m(t, e, a) {
            return (
              `${svcurl()
                ...
                ? `&template=${_euc(t.email_template)}`
                : ''
              }${e.vars ? `&vars=${_euc(e.vars)}` : ''
              }&lng=${
                w.lng() || 'xx'
              }&captcha_provider=nucaptcha&note=${
                _euc(e.note)
              }&${
                n('email', null, null, a)}`
            );
        ...
        (function (t) {
          ...
          function l(t, e) {
            ...
            if ((D.push(t), n() && FB.XFBML && FB.XFBML.parse)) { r(), FB.XFBML.parse(t); } else {
              if (
                !o &&
                  (i ||
                    ((i = v.ce('div')),
          ...
          function d(t, e, a, i) {
            ...
            (e.innerHTML =
                  `<div class="fb-${
                    ...
                    _ate.share.gcp(a.share, a.conf, `.${t}`).replace(',', '_')
                  }"></div>`),
              ...
              if (((passthrough = _ate.util.toKV(o)), (_ate.ufbl = 1), e())) {
                ...
                (i.src =
                      `//www.facebook.com/plugins/subscribe.php?href=${
                        _euc(_ate.track.mgu(a.share.url, { defrag: 1 }))
              ...
              if (
                ...
                (pinitButton.src =
                      ...
                      (_ate.bro.ie6 || _ate.bro.ie7 ? '?' : '#')
                        ...
                        _euc(n.media || i.media || '')
                      }&description=${
                        _euc(n.description)
                      }${n.layout
                      }&ats=${
                        _euc(_ate.util.rtoKV(o))
                      }&atc=${
          ...
          function n(t, e) {
            if (!t.ost) {
              ...
              if (
                ...
                (u.innerHTML = 'Tweet');
                for (const v in o) { o.hasOwnProperty(v) && u.setAttribute(`data-${v}`, o[v]); }
                t.appendChild(u),
                e.conf.pubid ||
                      (e.conf.pubid = addthis_config.pubid || _ate.pub()),
                a(t);
        ...
        (function (t, e) {
          ...
          function c(t, e) {
            if (t.className.indexOf('chiclet_style') != -1) { throw new Error('just do a chiclet'); }
            if (!t.ost) {
              let a = m(t, 'tm'),
                i = 50,
                n = 61;
              ...
              (t.innerHTML =
                    `<iframe title="AddThis | Tweetmeme" frameborder="0" width="${
                      i
                    }" height="${
                      n
        ...
        !(function (t) {
          function e(t) {
            ...
            (e.add = function (t, i) {
              if (typeof t === 'object') { for (const n in t) t.hasOwnProperty(n) && e.add(n, t[n]); } else a[t] = i;
            }),
            (e.get = function (t) {
              return a[t];
            }),
            ...
            (e.remove = function (t) {
              for (var e, i = 0; i < arguments.length; i++) {
                ...
                else if (e.length) { for (let n = 0; n < e.length; n++) delete a[e[n]]; }
              }
            }),
            (e.has = function (t) {
          ...
          function s(e) {
            function a() {
              ...
              if ((r--, r === 0)) {
                ...
                if (a.length === 0) { return m === C ? void 0 : ((D = !1), f(C), void s(e)); }
                for (
                  a = x(a, function (t) {
            ...
            function i(t) {
              if (((t = t || []), t.length && _ate.uls && window.JSON)) {
                ...
                if (F > 0) { for (; F-- > 0;) arguments[0].push(arguments[0].shift()); }
              ...
              query.hasOwnProperty(s) &&
                  ...
                  (c ? (c = !1) : (h += '&'),
                    ...
                    `${encodeURIComponent(s)
                      ...
                      encodeURIComponent(query[s])}`));
            }
            c ? (c = !1) : (h += '&'),
            (h +=
                  `callback=${
                    t.util.scb('fds', r + o, function () {
              ...
              s
                ...
                : B !== o[t]
                  ? (I.error(
                    `This key: \`${
                      t
                    }\` already exists for LoJson transmission.`
                  ),
                    !1)
                  : B === a[t]
      ...
      oi._rec.push(function (t) {
        ...
        if (
          ...
          if (qa.addthis_ssh) {
            let o = {},
              s = [];
            for (n = n.concat(oi._ssh), a = 0; a < n.length; a++) { (e = n[a]), o[e] || s.push(e), (o[e] = 1); }
            n = s;
          }
        ...
        (_adr.bindReady(),
          ...
          (function () {
            ...
            function e(t) {
              ...
              if (!_ate.unj || t.indexOf('{') !== 0) { return _ate.util.rfromKV(t, '&&', '=='); }
              try {
                return JSON.parse(t);
              } catch (e) {
            ...
            function a(t) {
              ...
              return (
                ...
                (c.hasKeys = function (t) {
                  ...
                  for (let e = 0; e < t.length; e++) { if (!c.iskey(t[e])) return !1; }
                  return !0;
                }),
                (c.iskey = function (t) {
                  if (
                ...
                (c.keys = function (t, a, o) {
                  ...
                  const s = [];
                  t == e.ASC ? i(o) : n(o);
                  for (let l = 0; l < r.length; l++) { s.push(typeof r[l] === 'object' ? r[l].name : r[l]); }
                  return s;
                }),
                (c.top = function (t, e) {
                  e || (e = 'score'), n(e);
          ...
          (Za.user = (function () {
            ...
            function x(t) {
              ...
              if (e.type == 'social') {
                if (!t) return !1;
                if (
                  (typeof t === 'string' && (t = t.split(',')), t instanceof Array)
                ) {
                  for (var a = {}, i = 0; i < t.length; i++) {
                    if (t[i] === 'all' && e.service && ja.list[e.service]) { return !0; }
                    a[t[i]] = 1;
                  }
              ...
              if (a.type == 'search') {
                if (
                  ...
                  if (a.terms && a.terms.length) {
                    for (e = 0; e < a.terms.length; e++) { if (!i[a.terms[e]]) return !1; }
                  }
                }
                return !0;
              }
      ...
      (window.addthis_open = function () {
        return (
          typeof iconf === 'string' && (iconf = null),
          _ate.ao(...arguments)
        );
      }),
    ...
    function (t, e, a) {
      ...
      t.exports = function (t, e, a) {
        ...
        for (n in s) {
          for (o in s[n][0]) { if (s[n][0][o] === a && s[n].length > e && s[n][e]) return s[n][e]; }
        }
        return t;
      };
    },,,, , ,
    ...
    function (t) {
      t.exports = function (t, e) {
        if (e && t !== e) {
          for (const a in e) { e.hasOwnProperty(a) && void 0 === t[a] && (t[a] = e[a]); }
        }
      };
    },
    function (t, e, a) {
    ...
    function (t, e, a) {
      ...
      function r(t, e) {
        if (
          ...
          for (let a = 0; a < t.length; a++) { if (z[t[a].split('-').shift()]) return (E = !0); }
        }
        return !1;
      }
      function l(t, e) {
    ...
    function (t, e, a) {
      ...
      t.exports = function (t) {
        ...
        let e,
          a;
        for (e in i) {
          if (((a = i[e]), a === '' && (a = `${e}.com`), t.indexOf(a) !== -1)) { return e; }
        }
        return null;
      };
    },
    ...
    function (t, e, a) {
      function i(t, e, a, i) {
        ...
        if (r) {
          ...
          if (((this._locations = new f(p)), a)) { for (h = 0; h < a.length; h++) this._locations[h] = a[h]; }
        } else {
        ...
        (this.test = function (t) {
          for (
            ...
            if (((e = a[i]), (o[Math.floor(e / 32)] & (1 << e % 32)) === 0)) { return !1; }
          }
          return !0;
        }),
        (this.size = function () {
        ...
        l = {
          ...
          bindReady() {
            if (!l.isBound && !_atc.xol) {
              if (((l.isBound = 1), r.readyState === 'complete')) { return void setTimeout(l.onReady, 1); }
              r.addEventListener &&
                !n('opr') &&
              ...
              if (n('saf')) {
                ...
                !(function () {
                  if (!l.isReady) {
                    ...
                    if (c === i) {
                      for (let t = r.gn('link'), e = 0; e < t.length; e++) { t[e].getAttribute('rel') === 'stylesheet' && c++; }
                      const a = r.gn('style');
                      c += a.length;
                    }
    ...
    function (t) {
      ...
      t.exports = function i(t) {
        ...
        if (t) {
          ...
          if (
            ((s = t[o]), (r = e(o)), s && typeof s === 'object' && 'length' in s)
          ) {
            for (n in s) {
              if (
          ...
          if (
            ((c = t[o]),
              ...
              typeof c === 'string')
          ) { r.appendChild(document.createTextNode(c)); } else if (c && typeof c === 'object' && c.nodeType === 1) { r.appendChild(c); } else {
            for (var l in c) {
              if (c.hasOwnProperty(l)) {
                if (
                  ((h = c[l]),
                    ...
                    l === 'className' || l === 'class'
                      ? (r.className = h)
                      : r.setAttribute(l, h); } else if (l == 'children') { for (var u in h) r.appendChild(i(h[u])); } else {
    ...
    function (t, e, a) {
      function i(t, e, a, v, g, m, w) {
        let b;
        if ((a && (b = g ? a(t, v, g) : a(t)), typeof b !== 'undefined')) { return b; }
        if (!f(t)) return t;
        const x = d(t);
        if (x) {
    ...
    function (t, e, a) {
      function i(t, e, a, i, o) {
        const r = e.length;
        if (t == null) return !r;
        for (var l = -1, c = !o; ++l < r;) { if (c && i[l] ? a[l] !== t[e[l]] : !s.call(t, e[l])) return !1; }
        for (l = -1; ++l < r;) {
          const h = e[l];
    ...
    function (t, e, a) {
      const i = a(50);
      t.exports = function () {
        for (var t; (t = i.pop());) { t && typeof t.close === 'function' && t.close(); }
      };
    },,
    function (t, e, a) {
      let i,
      ...
      t.exports = function () {
        let t;
        return i || (typeof _ate !== 'undefined' && _ate.uid
          ? (i = _ate.uid)
          : ((t = n.read('uid')), t && (i = t)),
          i);
      };
      ...
      t.exports = function (t, e) {
        ...
        return i(t, function (t, e) {
          ...
          if (e) {
            for (a in e) {
              if (typeof e[a] === 'string') {
                if (((i = (e[a] || '').split('=')), i.length !== 2 && e[a])) { o.push(e[a]); } else {
                  if (n[i[0]]) continue;
                  e[a] && o.push(e[a]);
                }
              }
    ...
    function (t) {
      t.exports = {
        source:
          `${(document.location.href.indexOf('https') === 0 ? 'https:' : 'http:') +
          _atr
          }sh.996b8e89.html`
      };
    },
    ...
    function (t, e, a) {
      ...
      (i.isWatching = function (t) {
        for (let e = i.watchList.length - 1; e >= 0; e--) { if (i.watchList[e] === t) return !0; }
        return !1;
      }),
      (i.handler = function () {
        setTimeout(function () {
    ...
    function (t, e, a) {
      ...
      function r(t) {
        ...
        for (let e = 0; e < g.length; e++) { for (var a = 0; a < t.length; a++) if (g[e] === t[a]) return; }
    ...
    function (t) {
      t.exports = function (t) {
        ...
        if (t instanceof Object) {
          let e = '';
          for (const a in t) { t.hasOwnProperty(a) && (e += (e.length > 0 ? ',' : '') + t[a]); }
          return e;
        }
        return null;
      };

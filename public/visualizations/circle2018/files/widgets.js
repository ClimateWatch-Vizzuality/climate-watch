      ...
      }(
        {
              ...
              (function () {
                  ...
                  O =
                    (Date.now ||
                      ...
                      function (t) {
                        ...
                        if (typeof t !== 'object') { throw new TypeError('Argument must be an object'); }
                ...
                var J = function (t, e) {
                  ...
                  K = function (t, e) {
                    ...
                    for (let s = t.length, a = 0; o._state === F && s > a; a++) { A(r.resolve(t[a]), void 0, n, i); }
                    return o;
                  },
                  Y = function (t, e) {
                    const n = this;
                    if (t && typeof t === 'object' && t.constructor === n) { return t; }
                    const i = new n(d, e);
                    return w(i, t), i;
                  },
                  Q = function (t, e) {
                    ...
                    p
                      ...
                      .forEach(function (t) {
                        ...
                        r(function () {
                          ...
                          p &&
                                (t.style.marginLeft =
                                  `-${Math.floor((d.width * p) / 100)}px`),
                          m &&
                                (t.style.marginTop =
                                  `-${
                                    Math.floor((d.height * m) / 100)
                                  }px`);
                        }),
                ...
                if (t) {
                  ...
                  (this.hideThread =
                      (e.conversation || this.dataAttr('conversation')) ==
                        'none' ||
                      w.contains(this.classAttr, 'tw-hide-thread')),
                  (this.hideCard =
              ...
              S.aug(r.prototype, {
                ...
                addSiteStyles() {
                  ...
                  return (
                    this.headingStyle &&
                        t.push(
                          `${N.map(e).join(',')}{${this.headingStyle}}`
                        ),
                    this.linkColor &&
                        (t.push(
                          `${this.linkColorSelectors.map(e).join(',')
                          }{color:${
                            this.linkColor
                          }}`
                        ),
                          t.push(
                            `${this.bgColorSelectors.map(e).join(',')
                            }{background-color:${
                              this.linkColor
                            }}`
                          ),
                          t.push(
                            `${this.linkStateColorSelectors.map(e).join(',')
                            }{color:${
                              _.lighten(this.linkColor, 0.2)
                            }}`
                          )),
                    this.borderColor &&
                        t.push(
                ...
                requestTweets(t, e, n) {
                  function i(t) {
                    if (((o.isUpdating = !1), t && t.headers)) {
                      if (t.headers.status == '404') { return void (o.pollInterval = null); }
                      if (t.headers.status == '503') { return void (o.pollInterval *= 1.5); }
                    }
                  }
                  function r(t) {
                    let i,
              ...
              f.aug(s.prototype, {
                ...
                modifyFrame(t) {
                  return (
                    ...
                    (this.constrainingWrapper.style.minWidth =
                        `${this.dimensions.MIN_WIDTH}px`),
                  ...
                  if (((o.innerHTML = t), (e = o.children[0]))) {
                    ...
                    return (
                      this.layout(function () {
                        ...
                        (i.constrainingWrapper.style.maxWidth =
                              `${parseInt(i.dimensions.maxHeight, 10) * c}px`);
                      }),
            ...
            function (t, e, n) {
              ...
              function o() {
                for (
                  ...
                  for (u = 0; (e = t[u]); u++) { if (l.test(e.rel) && (n = c.screenName(e.href))) return n; }
                }
              }
              var s = t(12),
                a = t(13),
          ...
          77: [
            function (t, e, n) {
              ...
              function o(t, e) {
                for (const n in t) { (!t.hasOwnProperty || t.hasOwnProperty(n)) && e(n, t[n]); }
                return t;
              }
              function s(t) {
                return {}.toString

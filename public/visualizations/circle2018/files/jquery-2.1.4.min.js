...
!(function (a, b) {
  ...
  n.fn.extend({
    ...
    is(a) {
      return !!x(this, typeof a === 'string' && u.test(a) ? n(a) : a || [], !1)
        .length;
    }
  });
  let y,
  ...
  let aa = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,
    ba = /<([\w:]+)/,
    ca = /<|&#?\w+;/,
  ...
  n.fn.extend({
    ...
    empty() {
      for (var a, b = 0; (a = this[b]) != null; b++) { a.nodeType === 1 && (n.cleanData(oa(a, !1)), (a.textContent = '')); }
      return this;
    },
    clone(a, b) {
      return (
    ...
    n.cssHooks[b] = {
      ...
      set(a, c, d) {
        ...
        return Ga(
          ...
          c,
          d
            ? Ha(a, b, d, n.css(a, 'boxSizing', !1, e) === 'border-box', e)
            : 0
        );
      }
    };
  ...
  (Ka.prototype = {
    ...
    cur() {
      const a = Ka.propHooks[this.prop];
  ...
  function Va(a, b, c) {
    ...
    if (n.isEmptyObject(m)) { (j === 'none' ? ta(a.nodeName) : j) === 'inline' && (o.display = j); } else {
  ...
  const _a = /^(?:input|select|textarea|button)$/i;
  n.fn.extend({
    prop(a, b) {
 ...
 if (
  ...
  const Ib = a.document.documentElement;
  function Jb(a) {

...
node {
  ...
  if (env.BRANCH_NAME == 'master') {
    ...
    feature_flags_env = feature_flags_env + ' --build-arg FEATURE_POP_UP=false  --build-arg FEATURE_SHOW_LTS_SUMMARY=true --build-arg FEATURE_WEB_TOUR=true --build-arg FEATURE_DYNAMIC_ZIP=true --build-arg FEATURE_ENHANCEMENT_CHANGES=true'
  }

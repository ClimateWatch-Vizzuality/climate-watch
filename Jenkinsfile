...
node {
  ...
  def feature_flags_env = '--build-arg FEATURE_AGRICULTURE=true  --build-arg FEATURE_POP_UP=true'
  ...
  if (env.BRANCH_NAME == 'master') {
    ...
    feature_flags_env = feature_flags_env + ' --build-arg FEATURE_COMPARE_ALL=false --build-arg FEATURE_POP_UP=false --build-arg FEATURE_ALL_COMMITMENTS_MENU_ITEMS=false'
  }

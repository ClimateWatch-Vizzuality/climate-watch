...
node {
  ...
  if (env.BRANCH_NAME == 'master') {
    ...
    feature_flags_env = feature_flags_env + ' --build-arg FEATURE_LTS_EXPLORE=false --build-arg FEATURE_COMMITMENTS_OVERVIEW=false --build-arg FEATURE_LTS_UPDATED_DATA=false --build-arg FEATURE_ALL_COMMITMENTS_MENU_ITEMS=false --build-arg FEATURE_NDC_FILTERING=false'
  }

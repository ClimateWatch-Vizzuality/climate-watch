...
node {
  ...
  if (env.BRANCH_NAME == 'master') {
    ...
    feature_flags_env = feature_flags_env + ' --build-arg FEATURE_NDC_EXPLORE=false --build-arg FEATURE_COMMITMENTS_OVERVIEW=false --build-arg FEATURE_NEW_GHG=false --build-arg FEATURE_ALL_COMMITMENTS_MENU_ITEMS=false  --build-arg FEATURE_NDC_FILTERING=false'
  }

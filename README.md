...
FEATURE_COMPARE_ALL: Compare All (Commitments menu) feature
FEATURE_POP_UP: Pop up shown entering the site
FEATURE_ALL_COMMITMENTS_MENU_ITEMS: This temporal feature flag is only to see all commitments menu items on staging while we are developing them

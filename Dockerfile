...
ARG FEATURE_NDCS_ENHANCEMENTS
ENV FEATURE_NDCS_ENHANCEMENTS $FEATURE_NDCS_ENHANCEMENTS

ARG FEATURE_LTS_EXPLORE
ENV FEATURE_LTS_EXPLORE $FEATURE_LTS_EXPLORE

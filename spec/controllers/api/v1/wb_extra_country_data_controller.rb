...
describe Api::V1::WbExtraCountryDataController, type: :controller do
  context do
    ...
    let!(:wb_extra_country_data) {
      FactoryGirl.create(:wb_extra_country_data, location: location)
    }

    let!(:wb_extra_country_data_1960) {
      FactoryGirl.create(:wb_extra_country_data, location: location, year: '1960')
    }

    let!(:wb_extra_country_data_1990) {
      FactoryGirl.create(:wb_extra_country_data, location: location, year: '1990')
    }

...
object_contents = {
  ...
  END
  "#{CW_FILES_PREFIX}historical_emissions/CW_HistoricalEmissions_sampledata_CAIT.csv" => <<~END,
  ...
  END
  "#{CW_FILES_PREFIX}historical_emissions/CW_HistoricalEmissions_sampledata_PIK.csv" => <<~END,
    Country,Source,Sector,Gas,GWP,1850,1851,1852
    ABW,PIK,Total including LUCF,CH4,AR2,0.00000469,0.00000475,0.00000483
  END
  "#{CW_FILES_PREFIX}historical_emissions/CW_HistoricalEmissions_sampledata_UNFCCC.csv" => <<~END,
    Country,Source,Sector,Gas,GWP,1990,1991,1992

...
object_contents = {
  ImportHistoricalEmissions::META_SOURCES_FILEPATH => <<~END,
    ...
    Climate Watch,Climate Watch,historical_emissions_climate_watch
  ...
  ImportHistoricalEmissions::META_SECTORS_FILEPATH => <<~END,
    ...
    UNFCCC_AI,AI,Total GHG emissions without LUCF,
  END
  ...
  ImportHistoricalEmissions::DATA_UNFCCC_FILEPATH => <<~END,
    Country,Source,Sector,Gas,GWP,1990,1991,1992
    ABW,UNFCCC_AI,Total GHG emissions without LUCF,Aggregate F-gases,AR4,6.242714951,6.264371648,6.183325393
  END
}

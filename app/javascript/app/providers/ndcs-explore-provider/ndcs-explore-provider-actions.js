...
const fetchNDCS = createThunkAction('fetchNDCS', props => (dispatch, state) => {
  ...
  promises.push(
    apiWithCache.get(
      '/api/v1/ndcs?indicators=ndce_ghg, submission, submission_date&filter=map&source[]=CAIT&source[]=Climate%20Watch&source[]=WB&source[]=NDC%20Explorer&source[]=UNICEF'
    )
  );

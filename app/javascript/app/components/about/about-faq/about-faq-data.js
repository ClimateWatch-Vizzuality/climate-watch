    ...
    content: [
      {
        ...
        answer: 'Pathways allows you to explore economic and emissions scenarios from a database of models from the IPCC, private sector and country-specific providers.'
      },
      {
        type: 'html',
        title: 'How can I use the Pathways tool?',
        answer: 'Pathways can be used to better understand the different development paths a country can take to reach its emission and sustainable development targets. The tool lets the user explore indicators and assumptions that make up each development pathway. It can be used to inform policy decisions to follow a certain pathway and work toward targets.<p> To watch a demo of the tool, please watch <a href="https://register.gotowebinar.com/register/7938728331287880705" rel="noopener noreferrer" target="_blank">this webinar</a>.</p>'
      },
      {
        type: 'text',
        title: 'What is your criteria for selecting models and scenarios? Will more be added?',
        answer: 'The models included on Pathways are published in peer-reviewed publications or are part of a government report; if other cases, they have been widely used by governments. We welcome additional modeling teams and institutions to add their models and contact us about uploading their data.'
      },
      {
        type: 'html',
      ...
      {
        type: 'text',
        title: 'What do the models say about whether we’re on track to keep global warming below 2°C? ',
        answer: 'The answer to this question varies by scenario. Almost all Business as Usual or Reference case scenarios show that we are not on track to keep global warming under 2°C. However, more ambitious scenarios show that it is possible to keep the global warming under 2°C by using technologies like carbon capture and storage with bioenergy and increased renewable energy.'
      },
      {
        type: 'text',
        title: 'Why can’t I compare countries and regions across different models?',
      ...
      },
      {
        ...
        answer: 'We are always looking to grow our database by adding new models. To upload your model and scenarios to Pathways, send us an email at <a href="climatewatch@wri.org">ClimateWatch@WRI.org</a> and we will send you with further information about model management and the data upload process. '
      }
    ]
  },
    ...
    content: [
      {
        ...
        answer: 'My Climate Watch is a feature that allows you to explore data on emission and economic scenarios from the Pathways module in depth and create and easily share custom visualizations such as timeseries charts, stacked bar charts and pie charts. '
      },
      {
        type: 'html',
        title: 'How do I log into MyClimateWatch?',
        answer: 'Log into <link to="/my-climate-watch" innertext="MyClimateWatch"> using your Google, Twitter or Facebook account. Registration and log-in via email are forthcoming.'
      }
    ]
  }
];

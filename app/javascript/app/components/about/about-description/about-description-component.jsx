  ...
  <div className={cx(layout.content, styles.aboutDescription)}>
    ...
    <AbbrReplace>
      <p>
        ...
        visualizations and resources they need to gather insights on national
        and global progress on climate change.
      </p>
      <p>
        Climate Watch brings together dozens of datasets for the first time to
      ...
      <ul>
        ...
        <li>
          <a href="/ndcs-sdg" className={styles.link}>
            ...
            Contributions (NDCs) and the Sustainable Development Goals (SDGs)
            and associated targets of the 2030 Agenda for Sustainable
            Development
          </a>
          ;
        </li>

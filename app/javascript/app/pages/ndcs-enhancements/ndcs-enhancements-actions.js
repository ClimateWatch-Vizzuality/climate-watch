...
const fetchNDCSEnhancements = createThunkAction('fetchNDCSEnhancements', () => (dispatch, state) => {
  const { ndcsEnhancements } = state();
  if (
    ndcsEnhancements &&
    (isEmpty(ndcsEnhancements.data) || isEmpty(ndcsEnhancements.data.indicators)) &&

ActiveAdmin.register_page 'Global Cw Platform Socioeconomics' do
  include DataUploader::SharedAdmin

  section_name = 'socioeconomics'
  ...
  controller do
    ...
    def s3_folder_path
      "#{CW_FILES_PREFIX}socioeconomics"
    end

    def path
      admin_global_cw_platform_socioeconomics_path
    end
    ...
    def import_worker
      DataUploader::BaseImportWorker.perform_async(section.id, 'ImportSocioeconomics', current_admin_user.email)
    end
  ...
  content do
    render partial: 'data_uploader/admin/form_upload_datasets', locals: {
      ...
      upload_path: admin_global_cw_platform_socioeconomics_upload_datafile_path,
      download_path: admin_global_cw_platform_socioeconomics_download_datafiles_path,

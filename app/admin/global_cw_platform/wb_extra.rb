ActiveAdmin.register_page 'Global CW Platform World Bank Extra' do
  ...
  controller do
    ...
    def import_worker
      DataUploader::BaseImportWorker.perform_async(section.id, 'ImportWbExtra', current_admin_user.email)
    end

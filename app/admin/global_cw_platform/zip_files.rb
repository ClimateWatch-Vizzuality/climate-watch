ActiveAdmin.register_page 'Global Cw Platform Zip Files' do
  include DataUploader::SharedAdmin

  section_name = 'zip_files'
  ...
  controller do
    ...
    def s3_folder_path
      "#{CW_FILES_PREFIX}zip_files"
    end

    def path
      admin_global_cw_platform_zip_files_path
    end
    ...
    def import_worker
      DataUploader::BaseImportWorker.perform_async(section.id, 'GenerateZIPFiles', current_admin_user.email)
    end
  ...
  content do
    render partial: 'data_uploader/admin/form_upload_datasets', locals: {
      ...
      upload_path: admin_global_cw_platform_zip_files_upload_datafile_path,
      download_path: admin_global_cw_platform_zip_files_download_datafiles_path,
      download_single_data_file_path:
          admin_global_cw_platform_zip_files_download_datafile_path,
      import_path: admin_global_cw_platform_zip_files_run_importer_path,
      abort_path: admin_global_cw_platform_zip_files_abort_importer_path,

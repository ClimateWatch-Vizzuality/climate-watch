ActiveAdmin.register_page 'Global Cw Platform Agriculture Profile' do
  ...
  controller do
    ...
    def path
      admin_global_cw_platform_agriculture_profile_path
    end
  ...
  content do
    render partial: 'data_uploader/admin/form_upload_datasets', locals: {
      ...
      upload_path: admin_global_cw_platform_agriculture_profile_upload_datafile_path,
      download_path: admin_global_cw_platform_agriculture_profile_download_datafiles_path,

ActiveAdmin.register_page 'Global Cw Platform Key Visualizations' do
  include DataUploader::SharedAdmin

  section_name = 'key_visualizations'
  ...
  controller do
    ...
    def s3_folder_path
      "#{CW_FILES_PREFIX}key_visualizations"
    end

    def path
      admin_global_cw_platform_key_visualizations_path
    end
    ...
    def import_worker
      DataUploader::BaseImportWorker.perform_async(section.id, 'ImportKeyVisualizations', current_admin_user.email)
    end
  ...
  content do
    render partial: 'data_uploader/admin/form_upload_datasets', locals: {
      ...
      upload_path: admin_global_cw_platform_key_visualizations_upload_datafile_path,
      download_path: admin_global_cw_platform_key_visualizations_download_datafiles_path,
      download_single_data_file_path:
          admin_global_cw_platform_key_visualizations_download_datafile_path,
      import_path: admin_global_cw_platform_key_visualizations_run_importer_path,
      abort_path: admin_global_cw_platform_key_visualizations_abort_importer_path,

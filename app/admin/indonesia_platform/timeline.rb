ActiveAdmin.register_page 'Indonesia Platform Timeline' do
  ...
  content do
    render partial: 'admin/form_upload_datasets', locals: {
      ...
      upload_path: admin_indonesia_platform_timeline_upload_datafile_path,
      download_path: admin_indonesia_platform_timeline_download_datafiles_path,
      download_single_data_file_path: admin_indonesia_platform_timeline_download_datafile_path,
      import_path: admin_indonesia_platform_timeline_run_importer_path
    }
  end
  ...
  page_action :upload_datafile, method: :post do
    ...
    redirect_to admin_indonesia_platform_timeline_path, notice: notice
  end

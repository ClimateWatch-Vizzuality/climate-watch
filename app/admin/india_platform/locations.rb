ActiveAdmin.register_page 'India Platform Locations' do
  ...
  content do
    render partial: 'admin/form_upload_datasets', locals: {
      ...
      upload_path: admin_india_platform_locations_upload_datafile_path,
      download_path: admin_india_platform_locations_download_datafiles_path,
      download_single_data_file_path: admin_india_platform_locations_download_datafile_path,
      import_path: admin_india_platform_locations_run_importer_path
    }
  end
  ...
  page_action :upload_datafile, method: :post do
    ...
    redirect_to admin_india_platform_locations_path, notice: notice
  end

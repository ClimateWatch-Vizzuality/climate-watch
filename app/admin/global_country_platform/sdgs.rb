ActiveAdmin.register_page 'Global Cw Platform Sdgs' do
  ...
  s3_folder_path = "#{CW_FILES_PREFIX_TEST}sdgs"
  ...
  content do
    render partial: 'admin/form_upload_datasets', locals: {
      ...
      upload_path: admin_global_cw_platform_sdgs_upload_datafile_path,
      download_path: admin_global_cw_platform_sdgs_download_datafiles_path,
      download_single_data_file_path: admin_global_cw_platform_sdgs_download_datafile_path,
  ...
  page_action :upload_datafile, method: :post do
    ...
    if params[:datafile].content_type != 'text/csv'
      redirect_to admin_global_cw_platform_sdgs_path, alert: "Upload failed
    ...
    redirect_to admin_global_cw_platform_sdgs_path, notice: notice
  end
  ...
  page_action :run_importer, method: :post do
    @job_id = ImportSdgsWorker.perform_async

ActiveAdmin.register_page 'Global Cw Platform Locations' do
  ...
  page_action :upload_datafile, method: :post do
    ...
    if params[:datafile].content_type != 'text/csv'
      redirect_to admin_global_cw_platform_locations_path, alert: "Upload failed
    ...
    redirect_to admin_global_cw_platform_locations_path, notice: notice
  end
  ...
  page_action :run_importer, method: :post do
    @job_id = ImportLocationsWorker.perform_async
